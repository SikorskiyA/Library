...
- Отправка пароля клиенту на электронный ящик (можно сделать с заглушкой, необязательно настоящая отправка на е-мейл), либо изменение и восстановление пароля клиентом;
